...
4. Now upload the class answer data and convert it to 1s and 0s. Each row of the class data is a response vector. How many unique response vectors are there in the class data? How many Ideal Response Vectors did you generate?
...
8. What change would you make to your Q-Matrix to attempt to lower its error score?
